...
class Template {
    ...
    public function __construct(int $template_id, string $name, string $description, int $category_id, string $image_path, float $price, string $created_at, string $updated_at) {
